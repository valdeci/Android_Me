...
public class BodyPartFragment extends Fragment {
    ...
    public void setmIndexImage(Integer indexImage) {
        this.mIndexImage = indexImage;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(mListIds != null){
            imageView.setImageResource(mListIds.get(mIndexImage));
        }else{
